...
import com.codeanapp.project.model.response.PageDataResponse;
...
public class BarangService {
    ...
    public DataTableResponse<Barang> getAllBarang(int page, int limit, String sortField, String sortOrder){
        try {
            Map<String, String> allowedOrder = new HashMap<>();
            allowedOrder.put("waktuRekam", "WAKTU_REKAM");
            String sortColumn = "WAKTU_REKAM";
            ...
            List<Barang> pageResult = barangMapper.getAllBarang(offset, limit, sortColumn, sortType);

            PageDataResponse<Barang> data = new PageDataResponse<>(page, limit, pageResult.size(), pageResult);
            ...
            log.error("Error when get all barang.", e);
            throw e;
        }
    }
}
